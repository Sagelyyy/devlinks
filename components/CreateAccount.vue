...
<template>
  ...
  >
    ...
    <div class="flex flex-col gap-6 w-full bg-white p-10 rounded-xl">
      <div class="flex flex-col gap-2">
        <h1 class="text-3xl font-instrument-bold text-dark-grey">
          Create account
        </h1>
        <p class="text-light-grey mb-10">
      ...
      <div class="flex flex-col gap-1">
        <label class="text-light-grey text-xs" for="password"
